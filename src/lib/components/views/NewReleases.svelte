<script lang="ts">
    ...
    function updatedAtSet() {
        const { music_updated_at, shows_updated_at, release_type, music_data, shows_data } =
            $newReleasesStore
        ...
        return (
            (music_updated_at && shows_updated_at) ||
            (music_data.length > 0 && shows_data.length > 0)
        )
    }
...
<ScrollArea
    class="mt-24 flex h-full w-full flex-col items-center justify-center py-10"
                            ...
                            <div class="relative flex h-16 w-full gap-2">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {#if $newReleasesStore.release_id === track.uri && $mediaStore.playing}
