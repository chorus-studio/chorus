...
<div class="grid grid-cols-2 w-full">
    <div class="flex flex-col items-center gap-y-1.5">
        <div class="flex items-center h-6">
            ...
            <Input bind:value={input.start} id="start" class="text-end pl-0 w-full h-6 font-bold rounded-none text-white text-base bg-[green] border-none" />
        </div>
        <div class="flex w-full items-center">
            ...
            <Input id="end" bind:value={input.end} class="w-full h-6 pl-0 text-end font-bold text-white text-base lowercase rounded-none bg-[green] border-none" />
        </div>
    </div>
