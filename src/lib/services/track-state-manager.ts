...
export class TrackStateManager {
    ...
    isAtTempSnipEnd(currentTimeMS: number, snip: { end_time?: number; last_updated?: string }): boolean {
        ...
        const loopEndTimeMS = !lastUpdateSet || last_updated === 'start' 
            ? endTimeMS 
            : endTimeMS + 3000
            
        return !Number.isNaN(endTimeMS) && 
