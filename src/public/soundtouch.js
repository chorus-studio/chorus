/*
 * SoundTouch Audio Worklet v0.2.0 AudioWorklet using the
...
var Stretch = (function (_AbstractFifoSamplePi2) {
    ...
    return _createClass(Stretch, [
        ...
        },
        {
            ...
            get: function get() {
                return (
                    this.overlapLength + Math.max(0, this.seekWindowLength - 2 * this.overlapLength)
                )
            }
        },
        {
        ...
        [
            {
                ...
                value: function process(inputs, outputs, parameters) {
                    ...
                    var rate =
                        (_parameters$rate$ = parameters.rate[0]) !== null &&
                        _parameters$rate$ !== void 0
                            ? _parameters$rate$
                            : parameters.rate
                    var tempo =
                        (_parameters$tempo$ = parameters.tempo[0]) !== null &&
                        _parameters$tempo$ !== void 0
                            ? _parameters$tempo$
                            : parameters.tempo
                    var pitch =
                        (_parameters$pitch$ = parameters.pitch[0]) !== null &&
                        _parameters$pitch$ !== void 0
                            ? _parameters$pitch$
                            : parameters.pitch
                    var pitchSemitones =
